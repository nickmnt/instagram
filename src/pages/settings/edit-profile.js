...
export default function EditProfile() {
    ...
    const handleSubmit = (e) => {
        ...
        await updateUserDetails(
            ...
            data.get('gender'),) ? toast("Success!") : toast("Failed to change password!");
        }
        ...
        <SettingsTemplate>
            ...
            <form className="edit-profile__form" onSubmit={handleSubmit}>
                ...
                <div className="edit-profile__form-item">
                    ...
                    <div className="edit-profile__info">Provide your personal information, even if the account is used for a business, a pet or something else. This won't be a part of your public profile.</div>
                </div>
                {/*<div className="edit-profile__form-item">
                    <div className="edit-profile__input-group">
