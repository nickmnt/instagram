...
export default function ChangePassword() {
    ...
    const handleSubmit = (e) => {
        ...
        const updateData = async () => {
            ...
            ) ? toast("Success!") : toast("Failed to change password!");
        }
            ...
            <SettingsTemplate>
                ...
                <div className="edit-profile">  
                    <div className="edit-profile__photo-container">
                        {user ? <img src={`/images/avatars/${user.username}.jpg`} alt="User" className="edit-profile__img" />
                        : <Skeleton />}
                        {user ? 
                        <div className="edit-profile__name">{user.username}</div>
                        : <Skeleton />}
                    </div>
                ...
                <form className="edit-profile__form" onSubmit={handleSubmit}>
                    ...
                    <div className="edit-profile__form-item">
                        <div className="edit-profile__input-group">
                            <input type="text" className="edit-profile__input" name="old-password"
                            value={oldPass} onChange={e=>setOldPass(e.target.value)}/>
                            <label className="edit-profile__title">Old Password</label>
                        </div>

                        <div className="edit-profile__input-group">
                            <input type="text" className="edit-profile__input" name="new-password"
                            value={newPass} onChange={e=>setNewPass(e.target.value)}/>
                            <label className="edit-profile__title">New Password</label>
                        </div>

                        <div className="edit-profile__input-group">
                            <input type="text" className="edit-profile__input" name="confirm-new-password"
